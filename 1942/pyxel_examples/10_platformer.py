...
class App:
    ...
    def draw(self):
        ...
        # This paints the background, same every 4 times we scroll (or something around this logic)
        pyxel.bltm(0, 0, 0, (scroll_x // 4) % 128, 128, 128, 128)
        # This paints the platforms,that have a transparent color so the background is seen beneath
